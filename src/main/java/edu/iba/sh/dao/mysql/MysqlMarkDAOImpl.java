...
public class MysqlMarkDAOImpl extends MysqlAbstractDAO implements MarkDAO {
    ...
    public List<Mark> getAllMarks() throws DAOException {
        logger.trace("MySQL.getAllMarks()");
    ...
    public Mark getMarkById(Integer id) throws DAOException {
        logger.trace("MySQL.getMarkById()");
        Connection connection = null;
        PreparedStatement statement = null;
        ResultSet set = null;
        try {
    ...
    public boolean deleteMarkById(Integer id) throws DAOException {
        logger.trace("MySQL.deleteMarkById()");
        Connection connection = null;
        PreparedStatement statement = null;
        try {
            connection = getConnection();
