...
public class MysqlUserDAOImpl extends MysqlAbstractDAO implements UserDAO {
	...
	public List<User> getAllUsers() throws DAOException {
		logger.trace("MySQL.getAllUsers()");
	...
	public User getUserById(String id) throws DAOException {
		logger.trace("MySQL.getUserById()");
		Connection connection = null;
		PreparedStatement statement = null;
		ResultSet set = null;
		try {
	...
	public boolean deleteUserById(String id) throws DAOException {
		logger.trace("MySQL.deleteUserById()");
		Connection connection = null;
		PreparedStatement statement = null;
		try {
			connection = getConnection();
	...
	public User getUserByIdAndPassword(String id, String password) throws DAOException {
		logger.trace("MySQL.getUserByIdAndPassword()");
		Connection connection = null;
		PreparedStatement statement = null;
		ResultSet set = null;
		try {
