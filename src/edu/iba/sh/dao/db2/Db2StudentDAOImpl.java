...
public class Db2StudentDAOImpl extends Db2AbstractDAO implements StudentDAO {
    ...
    public List<Student> getAllStudents() throws DAOException {
        logger.trace("DB2.getAllStudents()");
    ...
    public Student getStudentById(Integer id) throws DAOException {
        logger.trace("DB2.getStudentById()");
        Connection connection = null;
        PreparedStatement statement = null;
        ResultSet set = null;
        try {
    ...
    public boolean updateStudent(Integer id, Student student) throws DAOException {
        logger.trace("DB2.updateStudent()");
        Connection connection = null;
        PreparedStatement statement = null;
        try {
            connection = getConnection();
    ...
    public boolean deleteStudentById(Integer id) throws DAOException {
        logger.trace("DB2.deleteStudentById()");
        Connection connection = null;
        PreparedStatement statement = null;
        try {
            connection = getConnection();
